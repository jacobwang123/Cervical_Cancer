...
# This kernels aims at segmenting the cervix using the technique presented in this paper:
...
class Segmenter(img):
	...
	def cropCircle(img):
		...
		if cv2.countNonZero(gray) < gray.shape[0] * gray.shape[1] * 0.1:
	...
	#  - *R*, the distance of a pixel from the image center. The *R* feature provides spatial information
	# and supports the extraction of continuous regions within the image plane."
	...
	# we use Gaussian mixture modeling, initialized by a K-means procedure."
